...
--
-- Host: localhost
-- Generation Time: Sep 11, 2024 at 01:36 PM
...
--
-- Database: `hybrid_machine_learning`
--
CREATE DATABASE IF NOT EXISTS `hybrid_machine_learning` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `hybrid_machine_learning`;
...
('qjc70bx9cfwpdkx597eiiym63s6lyc89', 'eyJ1c2VyaWQiOjF9:1seuKm:l5UOBlX_FXTJmEuXyAX3sVqrry2Dcb0Uoe46yBF3ti0', '2024-08-30 10:37:28.735218'),
...
('rhlj2yoyec1eqw02bd73wy4p5afhwtes', 'eyJ1c2VyaWQiOjJ9:1sewdY:IzlYMWu9zDmJHmBzl6s8tQLzC38vF_Z-pe17upLwSAQ', '2024-08-30 13:05:00.397667'),
...
(1, 'Hariharan', 'Hariharan123@gmail.com', 'Hariharan', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
...
(7, 'Artificial Neural Network (ANN)', '48.80546075085324'),
(8, 'SGD Classifier', '46.75767918088737'),
(9, 'Gradient Boosting Classifier', '44.027303754266214'),
(10, 'Extra Tree Classifier', '48.4641638225256'),
(11, 'Artificial Neural Network (ANN)', '47.44027303754266');
...
(19, 'DDOS', '25.0'),
(20, 'WORMS', '50.0'),
(21, 'RECONNAISSANCE', '25.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_detect_botnet_attack`
--

CREATE TABLE IF NOT EXISTS `remote_user_detect_botnet_attack` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Fid` varchar(3000) NOT NULL,
  `SourcedFrom` varchar(3000) NOT NULL,
  `FileTimeUtc` varchar(3000) NOT NULL,
  `SourceIp` varchar(3000) NOT NULL,
  `SourcePort` varchar(3000) NOT NULL,
  `SourceIpAsnNr` varchar(3000) NOT NULL,
  `TargetIp` varchar(3000) NOT NULL,
  `TargetPort` varchar(3000) NOT NULL,
  `Payload` varchar(3000) NOT NULL,
  `SourceIpCountryCode` varchar(3000) NOT NULL,
  `SourceIpRegion` varchar(3000) NOT NULL,
  `SourceIpCity` varchar(3000) NOT NULL,
  `SourceIpLatitude` varchar(3000) NOT NULL,
  `SourceIpLongitude` varchar(3000) NOT NULL,
  `SourceIpMetroCode` varchar(3000) NOT NULL,
  `SourceIpAreaCode` varchar(3000) NOT NULL,
  `HttpRequest` varchar(3000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_detect_botnet_attack`
--

INSERT INTO `remote_user_detect_botnet_attack` (`id`, `Fid`, `SourcedFrom`, `FileTimeUtc`, `SourceIp`, `SourcePort`, `SourceIpAsnNr`, `TargetIp`, `TargetPort`, `Payload`, `SourceIpCountryCode`, `SourceIpRegion`, `SourceIpCity`, `SourceIpLatitude`, `SourceIpLongitude`, `SourceIpMetroCode`, `SourceIpAreaCode`, `HttpRequest`, `Prediction`) VALUES
(1, '10.42.0.211-64.71.142.124-40396-80-6', 'SinkHoleMessage', '131000000000000000', '103.244.49.56', '60125', 'AS132514', '204.95.99.86', '1888', 'Unknown', 'MY', '14', 'Kuala Lumpur', '3.1667', '101.7', '0', '0', 'lv0njxq80~Torrent~_6A7ED7950njxq80MYS0njxq80WIN_7 X64 SP10njxq800.3.10njxq80N0njxq80"Marvel''s Ultimate Spider-Man: Web Warriors" - Ep. 2, Clip 1 - YouTube - Google Chrome', 'WORMS'),
(2, '10.42.0.151-31.13.80.5-45358-443-6', 'SinkHoleMessage', '1.31E+17', '103.1.71.54', '60967', 'AS45960', '204.95.99.31', '288', 'Unknown', 'MY', '1', 'Johor Bahru', '1.4655', '103.7578', '0', '0', 'POST /is-ready HTTP/1.1', 'RECONNAISSANCE'),
(3, '172.217.6.234-10.42.0.42-443-52043-6', 'SinkHoleMessage', '1.31E+17', '175.142.9.76', '50457', 'AS4788', '204.95.99.109', '88', 'Unknown', 'MY', '7', 'Ipoh', '4.5841', '101.0829', '0', '0', 'POST /is-ready HTTP/1.1', 'DDOS'),
(4, '151.101.21.140-10.42.0.211-443-56701-6', 'SinkHoleMessage', '1.31E+17', '203.106.149.10', '8019', 'AS4788', '204.95.99.31', '105', 'Unknown', 'MY', '9', 'Penang', '5.4112', '100.3354', '0', '0', 'POST /is-ready HTTP/1.1', 'WORMS');
